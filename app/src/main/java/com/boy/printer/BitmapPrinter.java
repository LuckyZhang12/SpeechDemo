...
/**
 * Created by yankun on 2016/8/31.
 */
public class BitmapPrinter implements Printer {

    private OutputStream socketOut = null;
    private OutputStreamWriter writer = null;

    public BitmapPrinter(String printerIp, int port) throws IOException{
...
//        Bitmap newBitmap = compressPic(bitmap);
        byte[] data = draw2PxPoint(bitmap);
