 ...
 * 
 */
public class EscPosWebPrinter implements Printer {
	...
	public EscPosWebPrinter(String printerIp, int port) throws IOException {
		...
		writer = new OutputStreamWriter(socketOut, "GBK");// EUC-KR
		socketOut.write(27);
		socketOut.write(27);
...
//        setKoreanCharset();
    ...
    public void setKoreanCharset() throws IOException{
        writer.write(0x1B);
        writer.write(0x52);
        writer.write(0xD);
...
//        setKoreanCharset();
    ...
    public static void main(String[] argus) {
		...
		try {
			EscPosWebPrinter printer = new EscPosWebPrinter("10.156.120.52",
					9100);
